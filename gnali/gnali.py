...
def get_plof_variants(start_dir, temp_dir, *databases):
	...
	for database in databases:
		...
		os.system("xargs -a test_locations.txt -I {} tabix -fh %s {} > exomes_Results_%s.vcf" % (database, database_short))
		os.system("bgzip exomes_Results_%s.vcf" % (database_short))
		os.system("zgrep -e ';controls_nhomalt=[1-9]' exomes_Results_%s.vcf.gz > exomes_R_Hom_%s.txt" % (database_short, database_short))
		os.system("grep -e HC exomes_R_Hom_%s.txt > exomes_R_Hom_HC_%s.txt" % (database_short, database_short))
